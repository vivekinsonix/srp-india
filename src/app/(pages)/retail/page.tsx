    ...
    <section className="relative isolate overflow-hidden pt-5 ">
      ...
      <div className="mx-auto max-w-7xl  px-4 py-20 md:py-28 text-white">
        ...
        <p className="mt-4 max-w-2xl text-white/90">
          Create smooth, satisfying journeys across every channel, from first click to final purchase.
        </p>
        <div className="mt-8 flex flex-wrap items-center gap-3">
          <a href="#connect-with-us" className="rounded-xl bg-teal-600 px-4 py-2 font-semibold">Talk to us</a>
        ...
        <div className="flex md:gap-6 gap-3 py-3 text-sm">
          {[
            ...
            <a
              key={href}
              href={href as string}
              className="inline-flex items-center gap-2 px-3 py-2 rounded-xl hover:bg-slate-100 border border-transparent focus:border-slate-300"
            >
              {label}
            </a>
          ))}
    ...
    <section id="overview" className="container mx-auto px-4 py-12 md:py-16 grid md:grid-cols-2 gap-10 items-center">
      <div className="space-y-4">
        ...
        <p className="text-slate-600">
          In today’s retail environment, delivering exceptional, personalized experiences is critical amidst rising costs and
          shrinking margins. We go beyond providing technology; we’re a strategic partner committed to measurable outcomes.
        </p>
        <p className="text-slate-600">
          With proven experience across grocery, apparel, and e‑commerce (strengthened by our Ascensos acquisition), we help
          create seamless omnichannel journeys. By harnessing GenAI and intelligent automation, you’ll stay agile and elevate
          every interaction.
        </p>
      ...
      <img
        src="https://images.unsplash.com/photo-1515169273898-87e1e54f579b?q=80&w=1400&auto=format&fit=crop"
        alt="Retail collage"
  ...
  const items = [
    {
      ...
      text:
        "For a prominent US homecare retailer, AI-enabled multi-lingual CX increased CSAT and reduced support calls.",
    },
    {
      kpi: "5★",
      title: "Peak demand handled",
      text:
        "For a leading UK grocer we seamlessly managed peak demand and transition while enhancing customer experience.",
    },
    {
      kpi: "3 wks",
      title: "Omnichannel & CRM in record time",
      text:
        "Enabled a fashion retailer with scalable CX and CRM, cleared backlogs and improved performance metrics.",
    },
    {
      kpi: "86%",
      title: "CSAT with fraud‑resistant CX",
      text:
        "For a health & beauty retailer, we delivered high‑performance CX and fraud controls with excellent service.",
    },
  ];
  return (
    ...
    grocery: [
      {
        ...
        text:
          "Seamless lifecycle support—from bill payments to product inquiries, order tracking, and delivery resolution.",
      },
      {
  ...
  return (
    <section id="offerings" className="container mx-auto px-4 py-12 md:py-16">
      ...
      <p className="mt-3 max-w-3xl text-slate-600">
        Our CX platforms, Agentic AI solutions, and flexible services, powered by <span className="font-semibold">relAI™</span>,
        transform the way you operate—elevating experience, efficiency, and effectiveness for real outcomes.
      </p>
      ...
      <div className="mt-6 flex flex-wrap gap-2">
        {tabs.map((t) => (
          <button
            ...
            className={
              "inline-flex items-center gap-2 px-4 py-2 rounded-2xl border text-sm " +
              (active === t.key
  ...
  const features = [
    {
      ...
      text:
        "Reimagine omni-channel journeys—recruitment, field immersion, brand alignment, feedback loops, and measurable outcomes. Multilingual + AI insights for precision and empathy.",
    },
    {
      icon: <Cpu className="size-5" />,
      title: "Digital transformation",
      text:
        "Advanced technologies and analytics delivering integrated digital, predictive, and autonomous CX. GenAI transforms aftercare and field visits for high‑value products.",
    },
    {
      icon: <Layers className="size-5" />,
      title: "Supplier management solutions",
      text:
        "E2E coverage from customers to suppliers—verification, onboarding with cultural immersion, segmentation, and governance to reduce complaints.",
    },
    {
      icon: <Rocket className="size-5" />,
      title: "Peak support & capacity",
      text:
        "Decades of contact center expertise for rapid results—especially during high‑demand periods.",
    },
    {
      icon: <BarChart3 className="size-5" />,
      title: "Customer insights & analytics",
      text:
        "Audience-led analytics + modern data to create intelligent insights, collaboratively improving outcomes.",
    },
    {
      icon: <Bot className="size-5" />,
      title: "Business agility with AI-enabled working",
      text:
        "Embed AI across the agent lifecycle—from hiring to performance—with co‑pilot support for agility and efficiency.",
    },
  ];
        ...
        <div className="mt-6 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((f) => (
            <div key={f.title} className="rounded-3xl bg-white p-6 ring-1 ring-slate-200 shadow-sm">
              <div className="inline-flex items-center justify-center rounded-2xl bg-slate-900 text-white p-2">
                {f.icon}
              </div>
  ...
  const posts = [
    {
      tag: "Case study",
      title:
        "Retail e-commerce giant onboards 300 merchants in a quarter with a hybrid model",
    },
    {
      tag: "Whitepaper",
      ...
      <div className="mt-6 grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {posts.map((p, i) => (
          <article key={i} className="group rounded-3xl overflow-hidden ring-1 ring-slate-200 bg-white shadow-sm">
            <img
              src={`https://source.unsplash.com/collection/190727/${i + 1}`}
              alt="cover"
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-start">
          ...
          <div className="grid md:grid-cols-1 gap-4">
            ...
            {!submitted ? (
              ...
              <div className="mt-6 rounded-xl bg-green-50 text-green-900 p-4 text-sm">
