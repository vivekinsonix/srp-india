...
export default function Benefits() {
  const items = [
    {
      title: 'Compensation',
      points: ['Competitive salary with night-shift allowance', 'Performance bonus linked to QA/SLAs', 'Overtime in line with policy'],
    },
    {
      title: 'Growth',
      points: ['Learning stipend & certifications', 'Cross-training on tools (Zoho, Turvo, RingCentral)', 'Leadership pathways'],
    },
    {
      title: 'Wellbeing',
      points: ['Safe commute timings & policy', 'Paid leave & holiday calendar', 'Access to counseling partners'],
    },
    {
      title: 'Community',
      points: ['CSR volunteering options', 'Company events and recognition', 'Alumni network'],
    },
  ];
